...
const CareersPage = () => {
  ...
  const values = [
    ...
    { icon: 'fa-lightbulb', title: 'Clear thinking', desc: 'We value people who can take a complex problem, strip out the noise, and explain what actually matters, whether talking to a customer or to the wider team.' },
